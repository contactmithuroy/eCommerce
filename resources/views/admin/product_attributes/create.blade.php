...
<div class="card">
   <div class="card-header mt-3">
      <div class=" d-flex justify-content-between align-item-center ">
         <h3 class="card-title">Create product_attribute </h3>
   ...
   <div class="card-body p-0">
      <div class="card card-primary">
         <!-- form start -->
         <form role="form" action="{{ route('product_attribute.store') }}" id="create_product_attribute" method="POST"  enctype= multipart/form-data >
            @csrf
