                ...
                <div class="card card-primary">
                    <div class="row">
                        <div class="col-12 col-lg-6 col-md-8 offset-lg-3 offset-md-2">
                            <!-- form start -->
                            <form role="form" action="{{ route('tax.update',[$tax->id]) }}" id="update_tax">
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tax_description" value="{{ $tax->tax_description }}" class="form-control" id="tax_description" placeholder="Enter tax description" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="tax_value">Tax Value</label>
                                            <input type="text" name="tax_value" value="{{ $tax->tax_value }}" class="form-control" id="tax_value" placeholder="Enter tax_value" required>
                                        </div>
                                    </div>
                                </div>      
                                <!-- /.card-body -->               
